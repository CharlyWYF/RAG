...
from src.qa import PROMPT_TEMPLATE_V1


def main() -> None:
    parser = argparse.ArgumentParser(description="Run automated QA evaluation with the v1 prompt template")
